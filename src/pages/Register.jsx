...
export default function Register() {
  ...
  if (showOtp) {
    return (
      ...
      >
        ...
        <Button
          className="w-full h-12 font-medium bg-gradient-to-r from-[#00C7D9] to-[#00A8BD] hover:from-[#00A8BD] hover:to-[#0097A8] text-white shadow-lg shadow-[#00C7D9]/20"
        ...
        <p className="text-center text-sm text-slate-400 mt-4">
          ...
          <button onClick={handleResend} className="text-[#00C7D9] font-medium hover:underline">
            Reenviar
          </button>
        </p>
      </AuthLayout>
  ...
  return (
    <AuthLayout
      ...
      subtitle="Comenzá a administrar tu estudio contable"
      footer={
        <>
          ¿Ya tenés cuenta?{" "}
